...
[RecyclerView 布局管理器](https://github.com/mcxtzhang/ZLayoutManager)
...
[分页的PagerGridLayoutManager](https://github.com/shenbengit/PagerGridLayoutManager)

[FFmpegAndroid](https://github.com/xufuji456/FFmpegAndroid)

[AutoFitTextView自动缩小的textview](https://github.com/grantland/android-autofittextview)

[asyFloat：Android悬浮窗框架](https://github.com/princekin-f/EasyFloat)

[FloatingX悬浮窗](https://github.com/Petterpx/FloatingX)
...
[TagCloudView 球形组件](https://github.com/misakuo/3dTagCloudAndroid)

[Tag Sphere View球形转动](https://github.com/magic-goop/tag-sphere)

[Scroll Number Widget滚动数字组件](https://github.com/a-voyager/ScrollNumber/blob/master/README_zh.md)

[范围进度条](https://github.com/Jay-Goo/RangeSeekBar)

[FlycoLabelView 标签控件](https://github.com/H07000223/FlycoLabelView)

[SlantedTextView 标签控件](https://github.com/HeZaiJin/SlantedTextView)

[Audio Waves麦克风声音图形表示](https://github.com/FireZenk/AudioWaves)

[SimpleCropView 裁剪控件](https://github.com/igreenwood/SimpleCropView)

[Tesseract4Android 图片ocr识别](https://github.com/adaptech-cz/Tesseract4Android)

[tesseract 图片ocr识别](https://github.com/tesseract-ocr/tesseract)

[green dao 更新策略GreenDaoCompatibleUpdateHelper](https://github.com/af913337456/LghGreenDaoCompatibleUpdateHelper)

[android-ocr 图片ocr识别](https://github.com/SubhamTyagi/android-ocr)

[vosk pcm音频流识别文字](https://github.com/alphacep/vosk-android-demo)

[ExpandableTextView 折叠展开的textview](https://github.com/Carbs0126/ExpandableTextView)

[ExpandableLayout 折叠展开的layout](https://github.com/AAkira/ExpandableLayout)

[ExpandableLayout 折叠展开的layout](https://github.com/cachapa/ExpandableLayout)
...
[Android翻页效果](https://github.com/AnliaLee/BookPage)

[BookReader 小说阅读器](https://github.com/smuyyh/BookReader)

[treader 小说阅读器](https://github.com/PeachBlossom/treader)

[NovelReader 小说阅读器](https://github.com/newbiechen1024/NovelReader)

[小说阅读器](https://github.com/MewX/light-novel-library_Wenku8_Android)

[Aria 下载](https://github.com/AriaLyy/Aria)

[Fetch 下载](https://github.com/tonyofrancis/Fetch)
...
[卡片翻转布局](https://github.com/wajahatkarim3/EasyFlipView)

[BubbleView聊天气泡控件](https://github.com/houtrry/BubbleView)

[DanmakuFlameMaster 弹幕库控件](https://github.com/bilibili/DanmakuFlameMaster)

[HighlightPro 高亮组件，引导功能](https://github.com/hyy920109/HighLightPro)

[FingerprintIdentify 指纹识别库](https://github.com/uccmawei/FingerprintIdentify)

[ImagePicker 仿微信的相册选择](https://github.com/jeasonlzy/ImagePicker)

[NineGridView九图九宫格](https://github.com/jeasonlzy/NineGridView)

[NineGridImageView 九宫格](https://github.com/laobie/NineGridImageView)

[XXPermission 权限请求](https://github.com/getActivity/XXPermissions)

[PermissionX 权限请求](https://github.com/guolindev/PermissionX)

[parallaxdecoration视差装饰器](https://github.com/seagazer/parallaxdecoration)

[Flutter-UI-Kit 组件工具集](https://github.com/iampawan/Flutter-UI-Kit)

[FlutterUnit flutter组件收集](https://github.com/toly1994328/FlutterUnit)

[UltimateBarX 状态栏修改](https://github.com/Zackratos/UltimateBarX)

[ImmersionBar 状态栏导航栏 修改](https://github.com/gyf-dev/ImmersionBar)

[JsBridge webview与Android交互的桥梁](https://github.com/lzyzsd/JsBridge)

[JSbridge 用法的例子](https://github.com/beichensky/jsbridge-example)

[MagicaSakura bilibili多主体框架](https://github.com/bilibili/MagicaSakura)

[Android-skin-support android换肤框架](https://github.com/ximsfei/Android-skin-support)

[更换主题色示例](https://github.com/geminiwen/SkinSprite)

[AndroidChangeSkin 全无侵入的换肤方式](https://github.com/hongyangAndroid/AndroidChangeSkin)

[AndroidHttpCapture网络诊断工具](https://github.com/JZ-Darkal/AndroidHttpCapture)

[NetBare是一款网络包拦截和注入框架](https://github.com/MegatronKing/NetBare-Android)

[updownshortvideo 仿抖音上拉下滑短视频，加预缓存,接近秒开](https://github.com/o199666/updownshortvideo)

[AndroidVideoCache 视频缓存策略](https://github.com/danikula/AndroidVideoCache)

[JZVideo 饺子播放器](https://github.com/Jzvd/JZVideo)

[ExoPlayer 谷歌播放器](https://github.com/google/ExoPlayer)

[DKVideoPlayer 视频播放器](https://github.com/Doikki/DKVideoPlayer)
...
[甜甜圈组件](https://github.com/razerdp/AnimatedPieView)
...
[ShadowLayout 阴影布局](https://github.com/lihangleo2/ShadowLayout)

[LargeImage 加载大图](https://github.com/LuckyJayce/LargeImage)

[loading 特效组件](https://github.com/ybq/Android-SpinKit)

[Progress Button Android](https://github.com/leandroBorgesFerreira/LoadingButtonAndroid)

[多重水波纹 - MultiWaveHeader](https://github.com/scwang90/MultiWaveHeader)

[Calendar 日历](https://github.com/kizitonwose/Calendar)

[CalendarView 日历组件](https://github.com/huanghaibin-dev/CalendarView)

[NCalendar 日历组件](https://github.com/yannecer/NCalendar)

[SuperCalendar 日历组件](https://github.com/MagicMashRoom/SuperCalendar)

[直播礼物动画](https://github.com/qssq1/giftanim)

[ticker ](https://github.com/robinhood/ticker)

[svga 播放动画，直播礼物动画](https://github.com/svga/SVGAPlayer-Android)

[RichEditor for Android 富文本编辑](https://github.com/wasabeef/richeditor-android)

[MRichEditor 富文本编辑](https://github.com/Even201314/MRichEditor)

[PhotoEditor 图片编辑](https://github.com/burhanrashid52/PhotoEditor)

[StepView 流程步骤组件](https://github.com/baoyachi/StepView)

[google 的流程控件示例](https://github.com/fython/MaterialStepperView)

[HtmlTextView for Android](https://github.com/SufficientlySecure/html-textview)

[Textview 炫酷的特效](https://github.com/hanks-zyh/HTextView)

[AgentWeb 一个基于Android的WebView ](https://github.com/Justson/AgentWeb)

[支付宝 五福福卡的切换效果](https://github.com/smallnew/FuCardPager)

[Shimmer for Android](https://github.com/facebook/shimmer-android)

[google 浏览器](https://github.com/JackyAndroid/AndroidChromium)

[区块链钱包 web3](https://github.com/trustwallet/trust-web3-provider)

[区块链钱包](https://github.com/trustwallet/wallet-core)

[区块链钱包 dart版示例](https://github.com/kryptogo/bscscan_api)

[圆点指示器，kotlin compose版](https://github.com/tommybuonomo/dotsindicator)

[圆点指示器 跟随消失](https://github.com/wching/Android-Indefinite-Pager-Indicator)

[CircleIndicator 圆点指示器](https://github.com/ongakuer/CircleIndicator)

[ConvenientBanner 轮播组件](https://github.com/saiwu-bigkoo/Android-ConvenientBanner)

[BannerViewPager 轮播组件](https://github.com/zhpanvip/BannerViewPager)

[PlaceHolderView ](https://github.com/janishar/PlaceHolderView)

[jsoup 一款 Java 的HTML 解析器](https://github.com/open-android/jsoup)

[AppBarLayout 使用示例吧](https://github.com/henrytao-me/smooth-app-bar-layout)

[ItemTouchHelperDemo 今日头条 网易新闻 的频道排序、频道移动](https://github.com/YoKeyword/ItemTouchHelperDemo)

[TopGrid 高仿网易新闻新版频道管理功能](https://github.com/whatshappen/TopGrid)

[ChannelTagView 一个频道管理view，可拖拽排序，滑动删除。](https://github.com/yilylong/ChannelTagView)

[DragGridView 条目拖拽排序控件（主要用于新闻条目）](https://github.com/wkp111/DragGridView)

[SlidingLayout 实现类似微信网页浏览的下拉功能，也可以帮助你实现类似iOS中UITableView的下拉上拉弹跳的果冻效果。](https://github.com/HomHomLin/SlidingLayout)

[CoordinatorLayout behavior，来实现一些酷炫的效果](https://github.com/gdutxiaoxu/CoordinatorLayoutExample)
...
[aes 加解密](https://github.com/pkuoliver/EasyAES)

[权限封装 ](https://github.com/majunm/PermmisonCompat)

[MarqueeViewLibrary 一个很方便使用和扩展的跑马灯Library](https://github.com/gongwen/MarqueeViewLibrary)

[MarqueeView 跑马灯](https://github.com/sunfusheng/MarqueeView)

[CountdownView 倒计时 正计时组件](https://github.com/iwgang/CountdownView)

[PullZoomView 下拉头部放大，listview、scrollview](https://github.com/Frank-Zhu/PullZoomView)

[BadgeView 拖拽小红点](https://github.com/qstumn/BadgeView)

[ShineButton ](https://github.com/ChadCSong/ShineButton)

[RippleEffect 水波纹效果](https://github.com/traex/RippleEffect)
...
[Subsampling Scale Image View 大图加载](https://github.com/davemorrissey/subsampling-scale-image-view)

[RealtimeBlurView 高斯模糊组件](https://github.com/mmin18/RealtimeBlurView)

[android-drag-square 探探个人资料编辑页](https://github.com/xmuSistone/DragRankSquare)

[EasySwipeMenuLayout 侧滑item 菜单删除](https://github.com/anzaizai/EasySwipeMenuLayout)

[AndroidCamera 短视频编辑](https://github.com/aserbao/AndroidCamera)

[XPop popuwindow ](https://github.com/li-xiaojun/XPopup)

[MMKV 腾讯的高性能存储库](https://github.com/Tencent/MMKV)

[谷歌支付 示例](https://github.com/android/play-billing-samples)

[Google Pay API sample app for Android 谷歌支付示例](https://github.com/google-pay/android-quickstart)

[Broccoli 灰条预加载](https://github.com/samlss/Broccoli)

[autojs demo](https://github.com/snailuncle/autojsDemo)

[有趣的UI](https://github.com/mCyp/Orient-Ui)

[Spannable ](https://github.com/chenjj2048/SpannableStream)

[SimplifySpan](https://github.com/iwgang/SimplifySpan)

[SwipePanel（侧划控件）](https://github.com/Blankj/SwipePanel)

[易开发是一款帮助开发人员快速开发的工具，功能包括界面分析，页面信息等](https://github.com/WrBug/DeveloperHelper)

[StickyScrollViewItems ](https://github.com/emilsjolander/StickyScrollViewItems)

[LockScreenSample-Disable HomeButton or HomeKey Event 锁屏](https://github.com/hmm-umm/Android-LockScreenSample-DisableHomeButtonKey)

[ViewPagerIndicator 指示器](https://github.com/LinweiJ/ViewPagerIndicator)

[HeaderViewPager 共同头部的 ViewPager，支持与ListView，GridView，ScrollView，WebView，RecyclerView 嵌套使用](https://github.com/jeasonlzy/HeaderViewPager)

[StickyNavLayout 悬浮控件](https://github.com/ta893115871/StickyNavLayout)

[UETool](https://github.com/eleme/UETool)

[DiscreteScrollView ](https://github.com/yarolegovich/DiscreteScrollView)

[ViewDragHelper 示例](https://github.com/xiaosong520/ViewDragHelperDemo)

[DraggableView ](https://github.com/elevenetc/DraggableView)

[DragPhotoView 基于PhotoView](https://github.com/githubwing/DragPhotoView)

[Compressor 图片压缩](https://github.com/zetbaitsu/Compressor)

[Luban 图片压缩](https://github.com/Curzibn/Luban)

[AiYaCompressHelper 图片压缩](https://github.com/nanchen2251/CompressHelper)
